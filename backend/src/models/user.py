...
class User(Base):
    ...
    )  # None for OAuth-only (Google) accounts
    ...
    # Relationships
    firm: Mapped["Firm | None"] = relationship("Firm", back_populates="members")
...
class Firm(Base):
    ...
    # Relationships
    members: Mapped[list["User"]] = relationship("User", back_populates="firm")
