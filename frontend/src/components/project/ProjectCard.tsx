...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  const linkTo = isArchitect ? `/project/${project.id}/manage` : `/project/${project.id}`;

  return (
    <Link
      to={linkTo}
      className="border border-border bg-white hover:border-primary-300 transition-colors block group"
    >
      <div className="p-4">
