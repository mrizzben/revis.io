...
const PATHS: Record<string, string> = {
  ...
  // revision_restored
  undo:
    'M3 10h10a7 7 0 010 14H8m-5-4l4 4m-4-4l4-4',
  // revision_superseded
  forward:
  ...
  // item_forked
  fork:
    'M10 14l2-2m0 0l2 2m-2-2v6m-2 0h4m-2-6c.62-.56 1.45-.96 2.35-1.12 1.8-.33 3.42-1.72 3.97-3.45M10 14c-.62-.56-1.45-.96-2.35-1.12C5.85 12.55 4.23 11.16 3.68 9.43m2.5-2.29h3m-3 0V4m0 3.14H6.18M18.32 4.57h-3m3 0V7.7m0-3.13h.64',
  // option_created / option_updated
  puzzle:
    'M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z',
  // 📌 checkpoint pin
  pin:
    'M16.5 4L9.3 11.2m0 0a2 2 0 11-2.83 2.83 2 2 0 012.83-2.83zM9.3 11.2l7.2-7.2M16.5 4l3.5 3.5M13 9l2.5 2.5M9.3 11.2l-5.8 5.8a2 2 0 002.83 2.83l5.8-5.8M9.3 14.03V20m4.5-8.5h3.5l3.5 3.5h-3.5l-3.5-3.5z',
};
